"use strict";
function focusAtEnd(inputElement, e) {
...
function getSearchBarEl(hostname) {
    if (hostname.includes("google.com")) {
        let el = document.querySelector("#REsRA") || document.querySelector("#APjFqb");
        return el;
    }
    return null;
}
let searchEl = getSearchBarEl(window.location.hostname);
